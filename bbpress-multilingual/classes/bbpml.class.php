...
class BBPML {
    ...
    function plugin_init( ) {
        ...
        add_filter( 'bbp_get_search_url', array( $this, 'get_search_url' ), 10, 2 );
        add_filter( 'bbp_get_search_results_url', array( $this, 'get_search_results_url' ), 10, 2 );
    ...
    /*
     * Convert the search url to the current language
     * Added by potsky
     */
    ...
    /*
     * Convert the search result url to the current language
     * Added by potsky
     */
    function get_search_results_url( $url ) {
        global $sitepress;
        return $sitepress->convert_url( $url, $sitepress->get_current_language() );
    }
